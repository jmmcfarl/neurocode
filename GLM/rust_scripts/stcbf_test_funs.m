...
%fit model
stc_posneg_mod = fitNLHI_stcb_nopsc(glm_stcb,trstim,cspkbs2,'tots');
...
stc_posneg_xvLL = getLLGLM_STCBF(stc_posneg_mod,xvkern_output,xvspkbns,'none');

%%
f1 = plotfo1d_nopsc(stc_posneg_mod);
set(f1,'Position',[1300 1000 500 800]);
set(f1,'PaperUnits','centimeters'); 
set(f1, 'PaperSize', [15 5*nmods]); 
