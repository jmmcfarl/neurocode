function [glm0] = createGLM_quad(init_kerns,init_signs,defmod,basis,pix_conv_mat,kern_conv_mat)
...
for imod = 1:nmods
    ...
    if strcmp(tmod.nltype,'lin')
        tmod.nly = tmod.nlx;
    elseif strcmp(tmod.nltype,'quad')
        tmod.nly = tmod.nlx.^2;
        tmod.w = tmod.w/tmod.nlx(end);
    end
    mods = [mods,tmod];
