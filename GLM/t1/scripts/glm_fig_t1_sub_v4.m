...
%     
% %     gnmr4(xv) = fitGNM_internal_NLs(gnmr3(xv),X_tr,spikebins,0,0);
% %     gnmr4_xvLL(xv) = getLL_GNM(gnmr4(xv),X(xv_inds{xv},:),xv_spbs,'none');
% %  
% %     gnmr5(xv) = fitGNM_filters(gnmr4(xv),X_tr,spikebins,'none',[],1e-4,1e-6);
% %     gnmr5_xvLL(xv) = getLL_GNM(gnmr5(xv),X(xv_inds{xv},:),xv_spbs,'none');
...
quad_rel_xvLL = (null_xvLL - quadr_xvLL)/log(2);
