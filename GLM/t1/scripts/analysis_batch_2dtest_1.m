...
ncomps = [200:200:2000];
lambda_Lx1 = [0 1e-4 5e-4 1e-3 5e-3 2.5e-3];
cur_lx1 = 6;
...
set(f1, 'PaperSize', [30 20]);
set(f1,'PaperPosition',[0,0,(get(f1,'PaperSize'))])
pname = sprintf('fullpix_%ddX_%dL1',defmod.lambda_dX,cur_lx1);
print('-dpng',pname); close

fname = sprintf('fullpix_%ddX_%dL1',defmod.lambda_dX,cur_lx1);
save(fname,'glm_stcb','full_glm');
