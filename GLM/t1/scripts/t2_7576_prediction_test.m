...
NT = size(scores,1); %number of total stims
n_fold = 9;
seg_len = round(10/dt);
N_segs = floor(NT/seglen);
xv_inds = ceil(linspace(1,seg_len,NT)/(seg_len/(n_fold+1)));
...
% eval(sprintf('load cell%d_500wdims_5mods_350dX_40L1.mat',t));
