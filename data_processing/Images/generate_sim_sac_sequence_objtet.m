...
%%
imagedirectory = '~/James_scripts/data_processing/Images/object_test_ims/';
outdirectory = '~/James_scripts/data_processing/Images/processed_image_seqs_obj';
...
while ~isempty(im_set)
    ...
    while ~isempty(bad_pts)
        ...
        init_max_shift = 2/Pix2Deg;
        X(1,:) = rand(1,2)*2*init_max_shift - init_max_shift;
