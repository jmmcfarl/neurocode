...
%% plot mp trig averages    
   ...
   t_names = ['C:\WC_Germany\overall_calcs\trig_avgs_theta\mp_utrig_lf3orth' num2str(cell_type(d)) '_' over_names{d}];
   print('-dpng',t_names);
   xlim([-2 2]); grid on
      t_names = ['C:\WC_Germany\overall_calcs\trig_avgs_theta\mp_utrig_lf3orth_zoom_' num2str(cell_type(d)) '_' over_names{d}];
   print('-dpng',t_names);
...
close
   ...
   t_names = ['C:\WC_Germany\overall_calcs\trig_avgs_theta\mp_dtrig_lf3orth_' num2str(cell_type(d)) '_' over_names{d}];
   print('-dpng',t_names);
      xlim([-2 2]); grid on
      t_names = ['C:\WC_Germany\overall_calcs\trig_avgs_theta\mp_dtrig_lf3orth_zoom_' num2str(cell_type(d)) '_' over_names{d}];
   print('-dpng',t_names);
...
%% plot lf8 trig averages    
   ...
   t_names = ['C:\WC_Germany\overall_calcs\trig_avgs_theta\lf8_utrig_lf3orth_' num2str(cell_type(d)) '_' over_names{d}];
   print('-dpng',t_names);
      xlim([-2 2]); grid on
      t_names = ['C:\WC_Germany\overall_calcs\trig_avgs_theta\lf8_utrig_lf3orth_zoom_' num2str(cell_type(d)) '_' over_names{d}];
   print('-dpng',t_names);
...
close
   ...
   t_names = ['C:\WC_Germany\overall_calcs\trig_avgs_theta\lf8_dtrig_lf3orth_' num2str(cell_type(d)) '_' over_names{d}];
   print('-dpng',t_names);
      xlim([-2 2]); grid on
      t_names = ['C:\WC_Germany\overall_calcs\trig_avgs_theta\lf8_dtrig_lf3orth_zoom_' num2str(cell_type(d)) '_' over_names{d}];
   print('-dpng',t_names);
...
caxis([-3 3]);colorbar
    ...
    t_names = ['C:\WC_Germany\overall_calcs\trig_mats_theta\mp_utrig_mp_' num2str(cell_type(d)) '_' over_names{d}];
    print('-dpng',t_names);
    close
...
caxis([-3 3]);colorbar
line([0 0],[0 1],'Color','k')
    t_names = ['C:\WC_Germany\overall_calcs\trig_mats_theta\mp_utrig_lf8_' num2str(cell_type(d)) '_' over_names{d}];
    print('-dpng',t_names);
    close
...
caxis([-3 3]);colorbar
line([0 0],[0 1],'Color','k')
    t_names = ['C:\WC_Germany\overall_calcs\trig_mats_theta\mp_utrig_lf3orth_' num2str(cell_type(d)) '_' over_names{d}];
    print('-dpng',t_names);
    close
...
caxis([-3 3]);colorbar
line([0 0],[0 1],'Color','k')
    t_names = ['C:\WC_Germany\overall_calcs\trig_mats_theta\mp_utrig_lf2_' num2str(cell_type(d)) '_' over_names{d}];
    print('-dpng',t_names);
    close
...
%% plot mp down trig matrices
    ...
    line([0 0],[0 1],'Color','k')
        xlim([-2 3])
caxis([-3 3]);colorbar
t_names = ['C:\WC_Germany\overall_calcs\trig_mats_theta\mp_dtrig_mp_' num2str(cell_type(d)) '_' over_names{d}];
    print('-dpng',t_names);
    close
...
caxis([-3 3]);colorbar
line([0 0],[0 1],'Color','k')
    t_names = ['C:\WC_Germany\overall_calcs\trig_mats_theta\mp_dtrig_lf8_' num2str(cell_type(d)) '_' over_names{d}];
    print('-dpng',t_names);
    close
...
caxis([-3 3]);colorbar
line([0 0],[0 1],'Color','k')
    t_names = ['C:\WC_Germany\overall_calcs\trig_mats_theta\mp_dtrig_lf3orth_' num2str(cell_type(d)) '_' over_names{d}];
    print('-dpng',t_names);
    close
...
caxis([-3 3]);colorbar
line([0 0],[0 1],'Color','k')
    t_names = ['C:\WC_Germany\overall_calcs\trig_mats_theta\mp_dtrig_lf2_' num2str(cell_type(d)) '_' over_names{d}];
    print('-dpng',t_names);
    close
...
caxis([-3 3]);colorbar
line([0 0],[0 1],'Color','k')
    t_names = ['C:\WC_Germany\overall_calcs\trig_mats_theta\lf8_utrig_mp_' num2str(cell_type(d)) '_' over_names{d}];
    print('-dpng',t_names);
    close
...
caxis([-3 3]);colorbar
line([0 0],[0 1],'Color','k')
    t_names = ['C:\WC_Germany\overall_calcs\trig_mats_theta\lf8_utrig_lf8_' num2str(cell_type(d)) '_' over_names{d}];
    print('-dpng',t_names);
    close
...
caxis([-3 3]);colorbar
line([0 0],[0 1],'Color','k')
    t_names = ['C:\WC_Germany\overall_calcs\trig_mats_theta\lf8_utrig_lf3orth_' num2str(cell_type(d)) '_' over_names{d}];
    print('-dpng',t_names);
    close
...
caxis([-3 3]);colorbar
line([0 0],[0 1],'Color','k')
    t_names = ['C:\WC_Germany\overall_calcs\trig_mats_theta\lf8_utrig_lf2_' num2str(cell_type(d)) '_' over_names{d}];
    print('-dpng',t_names);
    close
...
caxis([-3 3]);colorbar
line([0 0],[0 1],'Color','k')
    t_names = ['C:\WC_Germany\overall_calcs\trig_mats_theta\lf8_dtrig_mp_' num2str(cell_type(d)) '_' over_names{d}];
    print('-dpng',t_names);
    close
...
caxis([-3 3]);colorbar
line([0 0],[0 1],'Color','k')
    t_names = ['C:\WC_Germany\overall_calcs\trig_mats_theta\lf8_dtrig_lf8_' num2str(cell_type(d)) '_' over_names{d}];
    print('-dpng',t_names);
    close
...
caxis([-3 3]);colorbar
line([0 0],[0 1],'Color','k')
    t_names = ['C:\WC_Germany\overall_calcs\trig_mats_theta\lf8_dtrig_lf3orth_' num2str(cell_type(d)) '_' over_names{d}];
    print('-dpng',t_names);
    close
...
caxis([-3 3]);colorbar
line([0 0],[0 1],'Color','k')
    t_names = ['C:\WC_Germany\overall_calcs\trig_mats_theta\lf8_dtrig_lf2_' num2str(cell_type(d)) '_' over_names{d}];
    print('-dpng',t_names);
    close
...
clear *mat
save C:\WC_Germany\overall_calcs\trig_avgs_theta\trig_avg_data lags mp* lf8*
