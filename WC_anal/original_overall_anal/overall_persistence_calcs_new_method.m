...
load C:\WC_Germany\overall_calcs\lf8_period_f_data_new_method
...
for d = 1:length(over_dir)
    ...
    line([0 0],[0 1],'Color','k')
    xlim([-2 10])
    tname = ['C:\WC_Germany\overall_calcs\persistence_calcs\new_method_' num2str(cell_type(d)) '_' over_names{d}];
    print('-dpng',tname);
    close
...
save C:\WC_Germany\overall_calcs\persistence_calcs\wcv_up_ctrig_data_new_method ...
