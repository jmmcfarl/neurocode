...
%     lf2_d = zscore(lf2_d);
    lf3_d = zscore(lf3_d);
    lf3h_d = jmm_smooth_1d(lf3h_d.^2,20);
    lf3h_d = zscore(lf3h_d);
%     lf5_d = zscore(lf5_d);
%     lf7_d = zscore(lf7_d);
    wcv_d = zscore(wcv_d);
...
%             lf2_up_ctrig_mat(i,:) = lf2_d(up_trans{d}(i)-backlag:up_trans{d}(i)+forwardlag);
            lf3_up_ctrig_mat(i,:) = lf3_d(up_trans{d}(i)-backlag:up_trans{d}(i)+forwardlag);
                        lf3h_up_ctrig_mat(i,:) = lf3h_d(up_trans{d}(i)-backlag:up_trans{d}(i)+forwardlag);
...
lf3h_up_ctrig_avg(d,:) = nanmean(lf3_up_ctrig_mat);
...
%     plot(up_state_dur{d}(up_order),(1:length(up_trans{d}))/length(up_trans{d}),'w','linewidth',2)
%     line([0 0],[0 1],'Color','k')
%         tname = ['C:\WC_Germany\JMM_Analysis_ste\lf8_up_ctrig_all\lf8_' f_names{d}];
%         print('-dpng',tname);
%         close
% %     %
...
%     plot(up_state_dur{d}(up_order),(1:length(up_trans{d}))/length(up_trans{d}),'w','linewidth',2)
%     line([0 0],[0 1],'Color','k')
%         tname = ['C:\WC_Germany\JMM_Analysis_ste\lf8_up_ctrig_all\lf2_' f_names{d}];
%         print('-dpng',tname);
%         close
...
%     plot(up_state_dur{d}(up_order),(1:length(up_trans{d}))/length(up_trans{d}),'w','linewidth',2)
%     line([0 0],[0 1],'Color','k')
%         tname = ['C:\WC_Germany\JMM_Analysis_ste\lf8_up_ctrig_all\lf3_' f_names{d}];
%         print('-dpng',tname);
%         close
    ...
    plot(up_state_dur{d}(up_order),(1:length(up_trans{d}))/length(up_trans{d}),'w','linewidth',2)
    line([0 0],[0 1],'Color','k')
        tname = ['C:\WC_Germany\JMM_Analysis_ste\lf8_up_ctrig_all\lf3h_' f_names{d}];
        print('-dpng',tname);
        close

%                 pcolor(lags/Fsd,(1:length(up_trans{d}))/length(up_trans{d}),lf5_up_ctrig_mat(up_order,:));shading flat
%         hold on
%                 caxis([-1 3]);colorbar
%     plot(up_state_dur{d}(up_order),(1:length(up_trans{d}))/length(up_trans{d}),'w','linewidth',2)
%     line([0 0],[0 1],'Color','k')
%         tname = ['C:\WC_Germany\JMM_Analysis_ste\lf8_up_ctrig_all\lf5_' f_names{d}];
%         print('-dpng',tname);
%         close
