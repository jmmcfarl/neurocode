...
function [up_state_dur,down_state_dur,up_trans,down_trans,sig_f2,int_thresh,tot_chopped_up,tot_chopped_down] = UDS_extract_run_hist(sig,threshold)
...
tot_chopped_down = tot_chopped_down + length(bad_downs);
...
tot_chopped_up = tot_chopped_up + length(bad_ups);
