...
%     end
    ...
    tname = ['C:\WC_Germany\Persistent_activity\UDS_dur_raw\max_up_dur_new_method_' f_names{d}];
    print('-dpng',tname)
    close all


    save C:\WC_Germany\Persistent_activity\UDS_dur_raw\UDS_raw_data_new_method up_state_dur* down_state_dur* up_trans* down_trans* 
    %
