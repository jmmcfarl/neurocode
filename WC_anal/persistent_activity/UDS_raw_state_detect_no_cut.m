...
load C:\WC_Germany\Persistent_activity\run_hist_thresh\run_thresh_data_oversmooth
...
%     end
    ...
    sm_threshold_w{d} = jmm_smooth_1d(threshold_w{d},thresh_smooth);
    sm_threshold_8{d} = jmm_smooth_1d(threshold_8{d},thresh_smooth);

    disp('WCV')
    [up_state_dur{d},down_state_dur{d},up_trans{d},down_trans{d},sig_w{d},int_thresh_w{d}] = UDS_extract_run_hist_no_cut(wcv_minus_spike,sm_threshold_w{d});
    disp('LFP')
    [up_state_dur8{d},down_state_dur8{d},up_trans8{d},down_trans8{d},sig_8{d},int_thresh_8{d}] = UDS_extract_run_hist_no_cut(lf8,sm_threshold_8{d});
    ...
    tname = ['C:\WC_Germany\Persistent_activity\UDS_dur_raw_no_cut\max_up_dur_' f_names{d}];
    print('-dpng',tname)
    close all


    save C:\WC_Germany\Persistent_activity\UDS_dur_raw_no_cut\UDS_raw_data_no_cut up_state_dur* down_state_dur* up_trans* down_trans* 
    %
