...
%     plot(t_axis{d}(find(uni_times_8{d})),threshold_8{d}(find(uni_times_8{d})),'r.','linewidth',3)
    ...
    t_name = ['C:\WC_Germany\current_injection\stellate\run_hist_thresh\' f_names{d}];
    print('-dpng',t_name)
    close all
...
save C:\WC_Germany\current_injection\stellate\run_hist_thresh\UDS_dur_data threshold*
