...
load C:\WC_Germany\sim_mich_probes\sim_mich_dir
load C:\WC_Germany\sim_mich_probes\run_hist_thresh\UDS_dur_data
...
for d = 1:17
    ...
    load used_data lf8 lf13

    wcv_minus_spike = lf13;
...
close
    ...
    tname = ['C:\WC_Germany\sim_mich_probes\UDS_dur_raw\max_up_dur_new_method_' f_names{d}];
    print('-dpng',tname)
    close all


    save C:\WC_Germany\sim_mich_probes\UDS_dur_raw\UDS_raw_data_new_method up_state_dur* down_state_dur* up_trans* down_trans* 
    %
