...
load C:\WC_Germany\tetrode_recs\tetrode_dir
load C:\WC_Germany\tetrode_recs\run_hist_thresh\UDS_dur_data
...
close
    ...
    tname = ['C:\WC_Germany\tetrode_recs\UDS_dur_raw\max_up_dur_new_method_005hz_' f_names{d}];
    print('-dpng',tname)
    close all


%     save C:\WC_Germany\persistent_revised\UDS_dur_raw\UDS_raw_data up_state_dur* down_state_dur* up_trans* down_trans* 
    %
