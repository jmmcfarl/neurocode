...
%      load sync_times synct
    ...
    total_dur = length(lf8)/2016; %in s
    clear synct
...
%     plot(t_axis{d}(find(uni_times_8{d})),threshold_8{d}(find(uni_times_8{d})),'r.','linewidth',3)
    ...
    t_name = ['C:\WC_Germany\tetrode_recs\run_hist_thresh\' f_names{d}];
    print('-dpng',t_name)
    close all
...
save C:\WC_Germany\tetrode_recs\run_hist_thresh\UDS_dur_data threshold*
