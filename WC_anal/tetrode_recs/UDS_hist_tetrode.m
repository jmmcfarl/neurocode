...
load up_per_data
    ...
    disp('WCV')
[up_state_dur,down_state_dur,up_trans,down_trans,sig_15,int_thresh_15] = UDS_extract_run_hist_t(lf15,sm_threshold_15);
disp('LFP')
[up_state_dur8,down_state_dur8,up_trans8,down_trans8,sig_8,int_thresh_8] = UDS_extract_run_hist_t(lf8,sm_threshold_8);

% dataViewer_run_hist(sig_15,sig_8,int_thresh_15,int_thresh_8,up_trans,up_trans8,down_trans,down_trans8)
...
%     close
    ...
    save UDS_dur avg* up_state_dur* down_state_dur* up_trans* down_trans* 
