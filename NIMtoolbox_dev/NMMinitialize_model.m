function nim = NMMinitialize_model( stim_params, mod_signs, NL_types, reg_params, Xtargets, init_filts, spk_NL_type)
%
...
if nargin < 4 || isempty(reg_params)
    reg_params = NMMcreate_reg_params(); %use default reg_params
end
...
%     spk_NL_params = [0 1 1]; %[theta beta alpha]
    spk_NL_params = [0 1 1 0]; %[theta beta alpha c]
