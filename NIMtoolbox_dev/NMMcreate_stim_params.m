function stim_params = NMMcreate_stim_params(stim_dims,stim_dt,up_samp_fac,tent_spacing)
%
% stim_params = NMMcreate_stim_params(stim_dims,<stim_dt>,<up_samp_fac>,<tent_spacing>)
%
