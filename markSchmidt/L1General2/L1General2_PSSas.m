function [w,f] = L1General2_PSSas(funObj,w,lambda,options,silent,max_iter)
...
[verbose,optTol,progTol,maxIter,suffDec,corrections,K] = ...
    myProcessOptions(options,'verbose',1,'optTol',1e-7,'progTol',1e-12,...
    'maxIter',max_iter,'suffDec',1e-4,'corrections',100,'K',[]);
% if silent == 1
%     verbose = 0;
% end
