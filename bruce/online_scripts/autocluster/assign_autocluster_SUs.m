...
% init_use_SUs = [19 36 48 64 94]; %for G087
% init_use_SUs = [17 44 55 64 85]; %for G088
% init_use_SUs = [25 48]; %for G089
% init_use_SUs = [18 42 43]; %for G091
init_use_SUs = [22 34 48 74 76 86 94]; %for G093
