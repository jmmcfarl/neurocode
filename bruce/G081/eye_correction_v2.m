...
%     new_k = reshape(resh_k,pad_SDIM*flen,2);
...
%     [old_LL(cc),~,~,prate] = getLL_GNM(init_quad_fit,X_zp,tr_spkbns,'none');
% %     new_LL(cc) = getLL_GNM(init_quad_fit,X_sh,tr_spkbns,'none');
%    
% end
% % figure
...
%%
% figure
% shadedErrorBar(all_stim_times(tr_inds),inferred_eye_cors*.04,inferred_eye_std*.04,{'r'})
% 
% hold on
% % plot(all_stim_times(tr_inds),rsac_inds,'r.-')
% % plot(all_stim_times(tr_inds),shift_cor*0.04,'.-')
