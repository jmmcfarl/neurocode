function [new_cluster,spike_features,spike_xy,Spikes] = apply_clustering_old(loadedData,init_cluster,params,fixed,Spikes)
...
elseif strcmp(new_cluster.fin_space,'template')
    ...
    spike_features = get_template_scores_old(Spikes.V,new_cluster.templates,new_cluster.template_params);
else
