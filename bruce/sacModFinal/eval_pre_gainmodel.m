function [LL,pred_rate,Gstim,fgint] = eval_pre_gainmodel( preGainMod, Robs, Xmat, Xsac_mat)

NT = length(Robs);
stim_mod = preGainMod.stim_mod;
...
sac_emb = create_time_embedding(Xsac_mat*preGainMod.stim_kernel,NMMcreate_stim_params(flen));
...
G = theta + Gstim + Xsac_mat*preGainMod.off_kernel;
