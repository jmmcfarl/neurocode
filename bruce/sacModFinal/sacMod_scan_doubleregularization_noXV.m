function [allSacMods] = sacMod_scan_doubleregularization_noXV(base_mod,Robs,Xsac,gain_sigs,fit_inds,basemod_pred_rate,poss_d2T_off,poss_d2T_gain,poss_L2_gain)
