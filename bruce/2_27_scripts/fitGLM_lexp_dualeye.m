function [myglm] = fitGLM_lexp_dualeye(myglm,X,spkbs,disp_type,its_per_round)
...
[ll0, ll0p] = getLLGLM_lexp_dualeye(myglm,X,spkbs,disp_type);
...
while eflag == 0
    ...
    [myglm eflag] = fitFULLRF_lexp_dualeye(myglm,X,Robs,its_per_round,'lbgs',0,optTol,progTol);
    if check_user_in == 1
