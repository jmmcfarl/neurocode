...
for eye = 1:2
    ...
    if eye == 1
        save left_eye_pgabortrack_d1_nt2 loglik cur_*_seq dX dY post_std* post_entropy gabor_params LL
    else
        save right_eye_pgabortrack_d1_nt2 loglik cur_*_seq dX dY post_std* post_entropy gabor_params LL
...
close all
use_it = 5;
load left_eye_pgabortrack_d1_nt2
...
load right_eye_pgabortrack_d1_nt2
