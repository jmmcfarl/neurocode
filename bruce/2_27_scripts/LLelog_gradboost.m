function [ll,grad] = LLelog_gradboost(K,X,cur_mod_out,Scur_mod_out,S,lamrange,lamrange2,llist, hold_const, nlxrange)
%
...
kx = X*k+b+cur_mod_out;
ks = S*k+b+Scur_mod_out;
