function [gabor_params,LL] = fit_gabor_params(init_params,Xmat,Robs,msize,hold_const,LB,UB)
...
[params LL] = fmincon( @(K) get_pgabor_LL(K, Xmat, Robs, msize,hold_const,fixed_params), ...
...
function LL = get_pgabor_LL(K,Xmat,Robs,msize,hold_const,fixed_params)
