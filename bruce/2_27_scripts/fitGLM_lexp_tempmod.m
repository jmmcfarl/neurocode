function [myglm] = fitGLM_lexp_tempmod(myglm,X,spkbs,T,disp_type,its_per_round)
...
while eflag == 0
    ...
    [myglm eflag] = fitFULLRF_lexp_tempmod(myglm,X,Robs,T,its_per_round,'lbgs',0,optTol,progTol);
    if check_user_in == 1
