...
poss_SFs = [0.25 0.5:0.5:8]; %possible pref spatial frequencies
% poss_SFs = [0.5:2:15]; %possible pref spatial frequencies
...
xax = -5:pix_dx:5; %spatial axis (deg)
...
ex_SF = 2; %sample SF
sigma_vals = 0.0:.01:0.2; %range of EP sigma values
