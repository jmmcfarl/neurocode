...
% anal_name = 'dualori_eyecorr2';
anal_name = 'dualori_eyecorr4';
...
% 
% %subtract off median position for each trial
...
% 
% fprintf('\nTotal correlation:\nLH:%.3f LV:%.3f \nRH:%.3f RV:%.3f\n',tot_corrs(1,1),tot_corrs(2,2),tot_corrs(3,1),tot_corrs(4,2));
% fprintf('\nDrift correlation:\nLH:%.3f LV:%.3f \nRH:%.3f RV:%.3f\n',drift_corrs(1,1),drift_corrs(2,2),drift_corrs(3,1),drift_corrs(4,2));
