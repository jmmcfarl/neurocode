...
if bar_ori == 0
    ...
    old_anal_name = 'monoc_eyecorr_hbar';
    anal_name = 'monoc_eyecorr_hbar_highres';
    hrmod_data_name = 'monoc_eyecorr_hbar_mods_hres';
else
    mod_data_name = 'monoc_eyecorr_vbar_mods';
    old_anal_name = 'monoc_eyecorr_vbar';
    anal_name = 'monoc_eyecorr_vbar_highres';
    hrmod_data_name = 'monoc_eyecorr_vbar_mods_hres';
end
...
all_post_cor = round((fix_post_cor+drift_post_cor)*spatial_usfac/2) + max_Tshift + 1;
