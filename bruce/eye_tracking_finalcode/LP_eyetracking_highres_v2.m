...
anal_name = 'monoc_eyecorr_highres5';
hrmod_data_name = 'monoc_eyecorr_mods_hres5';
...
%             h2=shadedErrorBar(all_t_axis(used_inds(uu))-bt,fin_fix_corr(uu),fin_fix_std(uu),{'color','m'});
            ...
            h3=plot(all_t_axis(used_inds(uu))-bt,corrected_eye_vals_interp(used_inds(uu),4),'g','linewidth',2);
