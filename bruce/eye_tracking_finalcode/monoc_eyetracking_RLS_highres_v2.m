...
if bar_ori == 0
    ...
    old_anal_name = 'monoc_eyecorr_hbar2';
%     anal_name = 'monoc_eyecorr_hbar_highres4';
    anal_name = 'monoc_eyecorr_hbar_highres3_tight3';
    hrmod_data_name = 'monoc_eyecorr_hbar_mods_hres2';
%         mod_data_name = 'monoc_eyecorr_hbar_mods_randinit';
%         old_anal_name = 'monoc_eyecorr_hbar_randinit2';
%         anal_name = 'monoc_eyecorr_hbar_randinit_highres3';
%         hrmod_data_name = 'monoc_eyecorr_hbar_randinit_mods_hres2';
else
    mod_data_name = 'monoc_eyecorr_vbar_mods';
    old_anal_name = 'monoc_eyecorr_vbar2';
    anal_name = 'monoc_eyecorr_vbar_highres2';
    hrmod_data_name = 'monoc_eyecorr_vbar_mods_hres2';
end
