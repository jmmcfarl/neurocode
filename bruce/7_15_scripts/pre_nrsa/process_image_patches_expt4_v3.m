...
resh_all_stims = reshape(all_im_patches,n_un_stims,sdim^2);
...
save('Expt4_newcompiled_data_d1p25_htres.mat','-v7.3','full_*','resh_all*','sac_*','from*','dt','Fsd','RF_patch*','xax','yax','*_inds','dsfrac');
%%
