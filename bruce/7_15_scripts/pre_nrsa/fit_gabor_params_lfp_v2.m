function [gabor_params,LL] = fit_gabor_params_lfp_v2(XX,YY,init_params,Xmat,obs_amps,hold_const,LB,UB)
...
[params LL] = fmincon( @(K) get_pgabor_LL(K, Xmat, obs_amps, XX,YY,hold_const,fixed_params), ...
...
function LL = get_pgabor_LL(K,Xmat,obs_amps,XX,YY,hold_const,fixed_params)
