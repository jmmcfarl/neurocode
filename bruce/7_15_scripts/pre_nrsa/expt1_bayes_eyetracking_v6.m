...
load ./Expt1_newcompiled_data_fixeddelay_d1p25_new.mat
...
%             cur_lA = bsxfun(@plus,cur_lA,leps_prior'); %factor in constant prior
    ...
    for t = 1:96
        ...
        [gabor_params_f{it+1}(t,:),LL(it+1,t)] = fit_gabor_energy_mod_varmeanrate(XXc,YYc,init_params,fullX_cropped,...
            full_binned_spks(:,t),full_expt_vec,hold_const,LB,UB,gab_priors);
...
%%
save gabor_tracking_varmeans gabor_* LL xv_set tr_set x_cor y_cor 
