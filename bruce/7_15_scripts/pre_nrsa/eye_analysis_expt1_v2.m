...
save all_eyedata_expt1_34 all*

%%
plot(all_t-all_t(1),all_inblink,'k')
hold on
plot(all_t-all_t(1),all_eyepos(:,1))
plot(all_t-all_t(1),all_eyepos(:,3),'r')

plot(all_t(all_sac_start_inds)-all_t(1),all_eyepos(all_sac_start_inds,1),'ro','linewidth',2)
plot(all_t(all_lsac_stop_inds(:,1))-all_t(1),all_eyepos(all_lsac_stop_inds(:,1),1),'go','linewidth',2)

plot(all_t(all_sac_start_inds)-all_t(1),all_eyepos(all_sac_start_inds,3),'ro','linewidth',2)
plot(all_t(all_rsac_stop_inds(:,1))-all_t(1),all_eyepos(all_rsac_stop_inds(:,1),3),'go','linewidth',2)
