function [gabor_params,LL] = fit_gabor_energy_mod_lfp(XX,YY,init_params,Xmat,obs_amps,hold_const,LB,UB,priors)
...
[params LL] = fmincon( @(K) get_pgabor_LL(K, Xmat, obs_amps,XX,YY,hold_const,fixed_params,priors), ...
...
function LL = get_pgabor_LL(K,Xmat,obs_amps,XX,YY,hold_const,fixed_params,priors)
