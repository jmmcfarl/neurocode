...
%%
cd ~/Data/bruce/7_15_12/G034/
save expt2_lfp_amp_models_v3 B_stimmod wfreqs tent_centers lfp_gabor_params LL rsq* orientations
...
for i = 1:96
    subplot(2,1,1)
    pcolor(tent_centers,wfreqs,squeeze(B_stimmod(i,:,1:ntents)));shading flat
    set(gca,'yscale','log')
    subplot(2,1,2)
    
    pcolor(tent_centers,wfreqs,squeeze(B_stimmod(i,:,ntents+1:end)));shading flat
    set(gca,'yscale','log')
pause
clf
end