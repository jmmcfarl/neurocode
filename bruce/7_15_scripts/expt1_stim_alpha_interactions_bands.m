...
load ./expt1_lfp_alpha_phase_delay_all_sameelec_bands.mat
...
%%
save extp1_stim_alpha_models_same_elec_bands xv_* freq_bands pax stim_* *_prctiles prctile*
...
avg_phase_pos = reshape(mean(stim_ind_filt_pos(ucells,:)),nbins,n_bands)';
