...
% plot(slags*dt,sacStimProc(cc).gsacGainMod.stim_kernel+1,'k');
% plot(slags*dt,sacStimProc(cc).gsacGainMod.gain_kernel+1,'b');
% plot(slags*dt,sacStimProc(cc).gsac_post_singmod.mods(3).filtK+1,'r');
...
% plot(slags*dt,sacStimProc(cc).gsac_mod_info);
...
% plot(slags*dt,sacStimProc(cc).gsac_mod_info.*cur_avg_rate');
