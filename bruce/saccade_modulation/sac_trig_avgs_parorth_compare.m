...
%normalized firing rates within block
...
%general averages
[mua_data.p100_gsac_avgs,lags] = get_event_trig_avg(all_mua_rate_norm,p100_gsacs,backlag,forwardlag,nboot,used_trialvec,0);
[mua_data.p30_gsac_avgs,lags] = get_event_trig_avg(all_mua_rate_norm,p30_gsacs,backlag,forwardlag,nboot,used_trialvec,0);
[mua_data.o100_gsac_avgs,lags] = get_event_trig_avg(all_mua_rate_norm,o100_gsacs,backlag,forwardlag,nboot,used_trialvec,0);
[mua_data.o30_gsac_avgs,lags] = get_event_trig_avg(all_mua_rate_norm,o30_gsacs,backlag,forwardlag,nboot,used_trialvec,0);
