function [LL,LLgrad] = LLinternal_alphas_full3( mod, params, Robs, Xmat, Jmat, Xsac_mat, Xstim_sac_mat, L2_mats,lambda,lambda_L2)
...
G = G + Xstim_sac_mat*params((2*n_lags+1):(3*n_lags));
...
LLgrad(cur_set) = residual'*Xstim_sac_mat;
