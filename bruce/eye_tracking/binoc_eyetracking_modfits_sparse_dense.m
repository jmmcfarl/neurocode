...
anal_name = 'binoc_eyecorr_vbar_mods_sparse';
...
cur_block_set = find(included_type & expt_binoc' & expt_Fr == 1 & expt_bar_ori == bar_ori & expt_sac_dir == bar_ori & expt_dds == dds);
...
stim_var = 0.5*mean(std(all_left_stim_mat)) + 0.5*mean(std(all_right_stim_mat));
all_left_Xmat = all_left_Xmat/stim_var;
all_right_Xmat = all_right_Xmat/stim_var;
