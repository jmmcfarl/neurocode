...
anal_name = 'monoc_eyecorr_hbar_ETsim_gp25_v2';
mod_data_name = 'monoc_eyecorr_hbar_mods_ETsim_gp25';
...
drift_prior_sigma = 0.004*sim_gain;
...
sim_eyepos = tanh(sim_eyepos/max_sim_pos)*max_sim_pos;
...
sim_eyepos_rnd = round(sim_eyepos/(sp_dx*spatial_usfac));
