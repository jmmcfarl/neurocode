...
if bar_ori == 0
    mod_data_name = ['binoc_eyecorr_hbar_mods_Fin' use_eye];
    anal_name = ['binoc_eyecorr_hbar_Fin' use_eye];
else
    mod_data_name = ['binoc_eyecorr_vbar_mods_Fin ' use_eye];
    anal_name = ['binoc_eyecorr_vbar_Fin' use_eye];
end
