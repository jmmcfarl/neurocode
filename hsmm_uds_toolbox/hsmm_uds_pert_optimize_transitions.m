function [new_hsmm_state_seq] = hsmm_uds_pert_optimize_transitions(new_obs,hmm,orig_state_seq,gamma,Fs_orig,Fs_new,pert_range)
...
new_obs_d = downsample(new_obs,Fs_new/Fs_orig);
