function [gnm0] = createGNM_v2(init_kerns,init_signs,kern_types,init_linK,defmod,stim_params)
...
gnm0 = struct('mods',mods,'linK',init_linK(:),'LL',0,'LP',0,'stim_params',stim_params,'lambda_L1_lin',0,'lambda_d2T_lin',0);
