...
FieldSelection = [1 0 0 0 0];
Filename = 'Sc1.ntt';
[TimeStamps, Header] = Nlx2MatSpike(Filename, FieldSelection, ExtractHeader, ExtractMode);
...
for nn = 1:n_chunks
    ...
    [TimeStamps, DataPoints, Header] = Nlx2MatSpike(Filename, FieldSelection, ExtractHeader, 2,cur_range);
    ...
    sc1_avg_waveform = [sc1_avg_waveform cur_avg_waveform];
    sc1_std_waveform = [sc1_std_waveform cur_std_waveform];
end
...
for nn = 1:n_chunks
    ...
    sc2_avg_waveform = [sc2_avg_waveform cur_avg_waveform];
    sc2_std_waveform = [sc2_std_waveform cur_std_waveform];
