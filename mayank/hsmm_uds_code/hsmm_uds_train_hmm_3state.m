function hmm = hsmm_uds_train_hmm_3state(hmm,emiss)
...
%         flex_model_inds{i} = 1:length(UDS_seg_inds{i});
    ...
    if strcmp(hmm.meantype,'variable')
        ...
        fixedmean_est(2) = (fixedmean_est(1)+fixedmean_est(3))/2; %force transition state to be in between
    end
