function [hf_features,t_axis,Fs] = hsmm_uds_get_hf_features(sig,Fs_orig,dsf,cut_off_freqs,smooth_sigma)
...
obs_hf = zscore(downsample(obs_hf,dsf)); %normalize and down-sample
hf_features = obs_hf(:);
