...
for d = 1:length(sess_data)
    ...
    if exist('hsmm_state_seq_seg_lf_4_10_10_3.mat','file')
        load hsmm_state_seq_seg_lf_4_10_10_3
        load hsmm_state_seq8_seg_lf_4_10_10_3
        ...
        ylabel('Up state number','fontsize',14)
        title('Cortical LFP')
        t_names = ['G:\WC_Germany\parietal_cortical_2010\trig_mats\mp_utrig_' s_name];
        print('-dpng',t_names);
        close
        ...
        %     ylabel('Up state number','fontsize',14)
        %     title('Cortical LFP')
        %     t_names = ['G:\WC_Germany\parietal_cortical_2010\trig_mats\mp_utrig_un_' s_name];
        %     print('-dpng',t_names);
        %     close
        ...
        ylabel('Down state number','fontsize',14)
        title('Cortical LFP')
        t_names = ['G:\WC_Germany\parietal_cortical_2010\trig_mats\mp_dtrig_' s_name];
        print('-dpng',t_names);
        close
        ...
        %     ylabel('Down state number','fontsize',14)
        %     title('Cortical LFP')
        %     t_names = ['G:\WC_Germany\parietal_cortical_2010\trig_mats\mp_dtrig_un_' s_name];
        %     print('-dpng',t_names);
        %     close
        ...
        xlim([-2 3])
        line([0 0],[0 1],'Color','k')
        t_names = ['G:\WC_Germany\parietal_cortical_2010\trig_mats\lf8_utrig_' s_name];
        print('-dpng',t_names);
        close
        ...
        %     xlim([-2 3])
        %     line([0 0],[0 1],'Color','k')
        %     t_names = ['G:\WC_Germany\parietal_cortical_2010\trig_mats\lf8_utrig_un_' s_name];
        %     print('-dpng',t_names);
        %     close
        ...
        xlim([-3 3])
        line([0 0],[0 1],'Color','k')
        t_names = ['G:\WC_Germany\parietal_cortical_2010\trig_mats\lf8_dtrig_' s_name];
        print('-dpng',t_names);
        close
        ...
        %     xlim([-3 3])
        %     line([0 0],[0 1],'Color','k')
        %     t_names = ['G:\WC_Germany\parietal_cortical_2010\trig_mats\lf8_dtrig_un_' s_name];
        %     print('-dpng',t_names);
        %     close
