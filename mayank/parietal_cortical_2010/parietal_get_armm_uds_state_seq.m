function [armm_state_seq,armm,Fs,gamma] = ...
    parietal_get_armm_uds_state_seq(raw_data,raw_Fs,desynch_times,f_names)
...
max_order = 50;
emiss = obs_lf;
[w, A, C]=arfit(emiss, min_order, max_order);
ar_order = length(A);
[hmm] = jmm_initialize_arhmm(emiss,Fs,ar_order)
