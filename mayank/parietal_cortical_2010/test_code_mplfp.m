...
for i = 1:hmm.K
    ...
    hmm_mp_lf4_ham(d) = compute_state_seq_seg_hamdist_varuds(hmm_bb_state_seq,hmm_bb_state_seq4,hmm.UDS_segs,hmm4.UDS_segs,Fs_bb);
    hsmm_mp_lf4_ham(d) = compute_state_seq_seg_hamdist_varuds(hsmm_bb_state_seq,hsmm_bb_state_seq4,hmm.UDS_segs,hmm4.UDS_segs,Fs_bb);
...
%         (lf4,2016,desynch_times4);
%     fm_mp_lf4_ham(d) = compute_state_seq_seg_hamdist_varuds(fixmean_state_seq,fixmean_state_seq4,hmm.UDS_segs,hmm4.UDS_segs,Fs);
%     fmz_mp_lf4_ham(d) = compute_state_seq_seg_hamdist_varuds(fixmean_state_seqz,fixmean_state_seqz4,hmm.UDS_segs,hmm4.UDS_segs,Fs);
