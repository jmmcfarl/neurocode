...
%use only data sets with fronta/prefrontal LFP
...
%     end
%     save hsmm_state_seq_seg_lf_4_28_10_v3 hsmm* hmm* Fs* fract_low_post*
...
%     hmm.run_dur = toc;
%     save hsmm_state_seq_seg_fm_4_28_10_v3 hsmm* hmm* Fs*
%     clear hsmm* hmm* 
...
% compute LF4 state sequences
        ...
        tic
        [hsmm_bbstate_seq4,hsmm_state_seq4,hmm_bbstate_seq4,hmm4,Fs_bb,Fs,gamma] = ...
        ...
        fract_bad_model4(d) = length(hmm4.bad_model)/hmm4.Fs/hmm4.uds_dur;
...
%         save hsmm_state_seq4_seg_fm_4_28_10_v3 hsmm* hmm* Fs* 
%         clear hsmm* hmm* 
% 
%         tic
