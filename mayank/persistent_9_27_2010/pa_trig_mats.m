...
%     ylabel('Up state number','fontsize',14)
%     title('Cortical LFP')
%     t_names = ['G:\WC_Germany\persistent_9_27_2010\trig_mats2\mp_utrig_' s_name];
%     print('-dpng',t_names);
%     close
...
%     ylabel('Up state number','fontsize',14)
%     title('Cortical LFP')
%     t_names = ['G:\WC_Germany\persistent_9_27_2010\trig_mats2\mp_utrig_un_' s_name];
%     print('-dpng',t_names);
%     close
% 
...
%     ylabel('Down state number','fontsize',14)
%     title('Cortical LFP')
%     t_names = ['G:\WC_Germany\persistent_9_27_2010\trig_mats2\mp_dtrig_' s_name];
%     print('-dpng',t_names);
%     close
...
%     ylabel('Down state number','fontsize',14)
%     title('Cortical LFP')
%     t_names = ['G:\WC_Germany\persistent_9_27_2010\trig_mats2\mp_dtrig_un_' s_name];
%     print('-dpng',t_names);
%     close
...
%     xlim([-2 3])
%     line([0 0],[0 1],'Color','k')
%     t_names = ['G:\WC_Germany\persistent_9_27_2010\trig_mats2\lf8_utrig_' s_name];
%     print('-dpng',t_names);
%     close
...
%     xlim([-2 3])
%     line([0 0],[0 1],'Color','k')
%     t_names = ['G:\WC_Germany\persistent_9_27_2010\trig_mats2\lf8_utrig_un_' s_name];
%     print('-dpng',t_names);
%     close
% 
...
%     xlim([-2 8])
%     line([0 0],[0 1],'Color','k')
%     t_names = ['G:\WC_Germany\persistent_9_27_2010\trig_mats2\lf8_dtrig_' s_name];
%     print('-dpng',t_names);
%     close
%     
%     figure('visible','off')
...
%     xlim([-3 3])
%     line([0 0],[0 1],'Color','k')
%     t_names = ['G:\WC_Germany\persistent_9_27_2010\trig_mats2\lf8_dtrig_un_' s_name];
%     print('-dpng',t_names);
%     close
...
save pa_trig_avg_data mp_utrig* lf8_utrig* mp_dtrig* lf8_dtrig* lags