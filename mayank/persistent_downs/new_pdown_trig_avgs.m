...
%     end
    ...
    lfp_state_vec(isnan(lf8_period_vec)) = nan;
...
%         corresp_lf8_upinds{d},corresp_lf8_downinds{d},lfp_state_durations{d}{2},lfp_state_durations{d}{1},thresh_lf8_downdur,thresh_lf8_updur);
    ...
    non_skipped_dtrans = non_skipped_lfp_trans(mp_state_vec(down_trans_inds8(non_skipped_lfp_trans)) == 1); %non-skipped ctx down and mp in up
    ...
    non_skipped_utrans = non_dskipped_lfp_trans(mp_state_vec(up_trans_inds8(non_dskipped_lfp_trans)) == 0); %non-skipped ctx up and mp in down
...
%%
    ...
    [ctx_up_amps_hf,down_amps_hf] = get_state_amplitudes(lf8_hf,up_trans_inds8,down_trans_inds8);

    %%
    min_nstates = 5;
%     lf8_utrig_lf8(d,:) = get_event_trig_avg(lf8_lf,up_trans_inds8,backlag,forwardlag);
    [lf8_utrig_lf8(d,:),~,~,~,lf8_utrig_lf8_mat] = get_event_trig_avg(lf8_lf,up_trans_inds8,backlag,forwardlag,2);
    [lf8_utrig_hpc_hf(d,:),~,~,~,lf8_utrig_hpc_hf_mat] = get_event_trig_avg(hpc_hf,up_trans_inds8,backlag,forwardlag,2);
%     lf8_utrig_ctx_hf(d,:) = get_event_trig_avg(lf8_hf,up_trans_inds8,backlag,forwardlag);
    [lf8_utrig_ctx_hf(d,:),~,~,~,lf8_utrig_ctx_hf_mat] = get_event_trig_avg(lf8_hf,up_trans_inds8,backlag,forwardlag,2);
%     lf8_utrig_mp(d,:) = get_event_trig_avg(wcv_lf,up_trans_inds8,backlag,forwardlag);
    [lf8_utrig_mp(d,:),~,~,~,lf8_utrig_mp_mat] = get_event_trig_avg(wcv_lf,up_trans_inds8,backlag,forwardlag,2);
%     lf8_utrig_DCmp(d,:) = get_event_trig_avg(dc_interp_data,up_trans_inds8,backlag,forwardlag);
    [lf8_utrig_DCmp(d,:),~,~,~,lf8_utrig_DCmp_mat] = get_event_trig_avg(dc_interp_data,up_trans_inds8,backlag,forwardlag,2);
...
%     lf8_dtrig_mp(d,:) = get_event_trig_avg(wcv_lf,down_trans_inds8,backlag,forwardlag);
    [lf8_dtrig_mp(d,:),~,~,~,lf8_dtrig_mp_mat] = get_event_trig_avg(wcv_lf,down_trans_inds8,backlag,forwardlag,2);
%     lf8_dtrig_DCmp(d,:) = get_event_trig_avg(dc_interp_data,down_trans_inds8,backlag,forwardlag);
    ...
    if n_uskip(d) > min_nstates        
        ...
        lf8_utrig_ctx_hf_pup(d,:) = get_event_trig_avg(lf8_hf,up_trans_inds8(skipped_lfp_trans),backlag,forwardlag);
        ...
        lf8_dtrig_lf8hf_pup(d,:) = get_event_trig_avg(lf8_hf,down_trans_inds8(skipped_lfp_trans),backlag,forwardlag);
    ...
    lf8_utrig_lf8_npup(d,:) = get_event_trig_avg(lf8_lf,up_trans_inds8(non_skipped_dtrans),backlag,forwardlag);
    lf8_utrig_ctx_hf_npup(d,:) = get_event_trig_avg(lf8_hf,up_trans_inds8(non_skipped_dtrans),backlag,forwardlag);
    lf8_utrig_mp_npup(d,:) = get_event_trig_avg(wcv_lf,up_trans_inds8(non_skipped_dtrans),backlag,forwardlag);
    lf8_utrig_DCmp_npup(d,:) = get_event_trig_avg(dc_interp_data,up_trans_inds8(non_skipped_dtrans),backlag,forwardlag);
    lf8_dtrig_lf8_npup(d,:) = get_event_trig_avg(lf8_lf,down_trans_inds8(non_skipped_dtrans),backlag,forwardlag);
    lf8_dtrig_hpc_hf_npup(d,:) = get_event_trig_avg(hpc_hf,down_trans_inds8(non_skipped_dtrans),backlag,forwardlag);
    lf8_dtrig_ctx_hf_npup(d,:) = get_event_trig_avg(lf8_hf,down_trans_inds8(non_skipped_dtrans),backlag,forwardlag);
    lf8_dtrig_hpc_mua_npup(d,:) = get_event_trig_avg(hpc_mua_rate,down_trans_inds8(non_skipped_dtrans),backlag,forwardlag);
    lf8_dtrig_ctx_mua_npup(d,:) = get_event_trig_avg(ctx_mua_rate,down_trans_inds8(non_skipped_dtrans),backlag,forwardlag);
    lf8_dtrig_mp_npup(d,:) = get_event_trig_avg(wcv_lf,down_trans_inds8(non_skipped_dtrans),backlag,forwardlag);
    ...
    lf8_utrig_lf8_npdown(d,:) = get_event_trig_avg(lf8_lf,up_trans_inds8(non_skipped_utrans),backlag,forwardlag);
    lf8_utrig_hpc_hf_npdown(d,:) = get_event_trig_avg(hpc_hf,up_trans_inds8(non_skipped_utrans),backlag,forwardlag);
    lf8_utrig_ctx_hf_npdown(d,:) = get_event_trig_avg(lf8_hf,up_trans_inds8(non_skipped_utrans),backlag,forwardlag);
    lf8_utrig_hpc_mua_npdown(d,:) = get_event_trig_avg(hpc_mua_rate,up_trans_inds8(non_skipped_utrans),backlag,forwardlag);
    lf8_utrig_ctx_mua_npdown(d,:) = get_event_trig_avg(ctx_mua_rate,up_trans_inds8(non_skipped_utrans),backlag,forwardlag);
    lf8_utrig_mp_npdown(d,:) = get_event_trig_avg(wcv_lf,up_trans_inds8(non_skipped_utrans),backlag,forwardlag);
    lf8_utrig_DCmp_npdown(d,:) = get_event_trig_avg(dc_interp_data,up_trans_inds8(non_skipped_utrans),backlag,forwardlag);
    lf8_dtrig_lf8_npdown(d,:) = get_event_trig_avg(lf8_lf,down_trans_inds8(non_skipped_utrans),backlag,forwardlag);
    lf8_dtrig_mp_npdown(d,:) = get_event_trig_avg(wcv_lf,down_trans_inds8(non_skipped_utrans),backlag,forwardlag);
    lf8_dtrig_DCmp_npdown(d,:) = get_event_trig_avg(dc_interp_data,down_trans_inds8(non_skipped_utrans),backlag,forwardlag);   
    
    %%
    %skipped ctx downs
    if n_uskip(d) > min_nstates
        lf8_dtrig_lf8_pup_trial(d,:) = get_event_trig_avg(lf8_lf,down_trans_inds8(skipped_lfp_trans),backlag,forwardlag,[],lfp_state_number,-1,[],min_nstates);
        lf8_dtrig_ctx_hf_pup_trial(d,:) = get_event_trig_avg(lf8_hf,down_trans_inds8(skipped_lfp_trans),backlag,forwardlag,[],lfp_state_number,-1,[],min_nstates);
        lf8_dtrig_ctx_mua_pup_trial(d,:) = get_event_trig_avg(ctx_mua_rate,down_trans_inds8(skipped_lfp_trans),backlag,forwardlag,[],lfp_state_number,-1,[],min_nstates);
        lf8_dtrig_mp_pup_trial(d,:) = get_event_trig_avg(wcv_lf,down_trans_inds8(skipped_lfp_trans),backlag,forwardlag,[],mp_state_number,0,[],min_nstates);
        lf8_dtrig_DCmp_pup_trial(d,:) = get_event_trig_avg(dc_interp_data,down_trans_inds8(skipped_lfp_trans),backlag,forwardlag,[],mp_state_number,0,[],min_nstates);
    end
    lf8_dtrig_ctx_hf_npup_trial(d,:) = get_event_trig_avg(lf8_hf,down_trans_inds8(non_skipped_dtrans),backlag,forwardlag,[],lfp_state_number,-1,[],min_nstates);
    lf8_dtrig_lf8_npup_trial(d,:) = get_event_trig_avg(lf8_lf,down_trans_inds8(non_skipped_dtrans),backlag,forwardlag,[],lfp_state_number,-1,[],min_nstates);
    lf8_dtrig_ctx_mua_npup_trial(d,:) = get_event_trig_avg(ctx_mua_rate,down_trans_inds8(non_skipped_dtrans),backlag,forwardlag,[],lfp_state_number,-1,[],min_nstates);
    lf8_dtrig_mp_npup_trial(d,:) = get_event_trig_avg(wcv_lf,down_trans_inds8(non_skipped_dtrans),backlag,forwardlag,[],mp_state_number,2,[],min_nstates);
    lf8_dtrig_DCmp_npup_trial(d,:) = get_event_trig_avg(dc_interp_data,down_trans_inds8(non_skipped_dtrans),backlag,forwardlag,[],mp_state_number,2,[],min_nstates);
    
    if n_dskip(d) > min_nstates
        lf8_utrig_lf8_pdown_trial(d,:) = get_event_trig_avg(lf8_lf,up_trans_inds8(dskipped_lfp_trans),backlag,forwardlag,[],lfp_state_number,-1,[],min_nstates);
        lf8_utrig_ctx_hf_pdown_trial(d,:) = get_event_trig_avg(lf8_hf,up_trans_inds8(dskipped_lfp_trans),backlag,forwardlag,[],lfp_state_number,-1,[],min_nstates);
        lf8_utrig_ctx_mua_pdown_trial(d,:) = get_event_trig_avg(ctx_mua_rate,up_trans_inds8(dskipped_lfp_trans),backlag,forwardlag,[],lfp_state_number,-1,[],min_nstates);
        lf8_utrig_mp_pdown_trial(d,:) = get_event_trig_avg(wcv_lf,up_trans_inds8(dskipped_lfp_trans),backlag,forwardlag,[],mp_state_number,0,[],min_nstates);
        lf8_utrig_DCmp_pdown_trial(d,:) = get_event_trig_avg(dc_interp_data,up_trans_inds8(dskipped_lfp_trans),backlag,forwardlag,[],mp_state_number,0,[],min_nstates);
    end
    lf8_utrig_lf8_npdown_trial(d,:) = get_event_trig_avg(lf8_lf,up_trans_inds8(non_skipped_utrans),backlag,forwardlag,[],lfp_state_number,-1,[],min_nstates);
    lf8_utrig_ctx_hf_npdown_trial(d,:) = get_event_trig_avg(lf8_hf,up_trans_inds8(non_skipped_utrans),backlag,forwardlag,[],lfp_state_number,-1,[],min_nstates);
    lf8_utrig_ctx_mua_npdown_trial(d,:) = get_event_trig_avg(ctx_mua_rate,up_trans_inds8(non_skipped_utrans),backlag,forwardlag,[],lfp_state_number,-1,[],min_nstates);
    lf8_utrig_mp_npdown_trial(d,:) = get_event_trig_avg(wcv_lf,up_trans_inds8(non_skipped_utrans),backlag,forwardlag,[],mp_state_number,2,[],min_nstates);
    lf8_utrig_DCmp_npdown_trial(d,:) = get_event_trig_avg(dc_interp_data,up_trans_inds8(non_skipped_utrans),backlag,forwardlag,[],mp_state_number,2,[],min_nstates);
    ...
    corresp_mp_uplag(uset) = mp_uplags{d}(corresp_mp_upinds{d}(uset))/Fsd;
    
    uset = find(~isnan(corresp_mp_upinds{d}));
    corresp_mp_downlag{d} = nan(length(up_trans_inds8),1);
    corresp_mp_downlag{d}(uset) = mp_downlags{d}(corresp_mp_upinds{d}(uset))/Fsd;

    used_uptrans = find(up_trans_inds8 > backlag & up_trans_inds8 < length(lf8_lf)-forwardlag);
        non_skipped_set = find(mp_state_vec(up_trans_inds8(used_uptrans)) == 0);
        [~,ord] = sort(ctx_up_amps_hf(used_uptrans));
        ord(~ismember(ord,non_skipped_set)) = [];
        
        prev_ctx_downdur = nan(size(up_trans_inds8));
        prev_ctx_downdur(2:end) = lfp_state_durations{d}{1}(1:end-1);
        
        figure
        subplot(2,2,1)
%         imagesc(lags/Fsd,1:length(ord),lf8_utrig_ctx_hf_mat(ord,:));
        imagesc(lags/Fsd,1:length(ord),lf8_utrig_lf8_mat(ord,:));
        hold on
        plot(-prev_ctx_downdur(used_uptrans(ord)),1:length(ord),'w','linewidth',1.)
        line([0 0],[1 length(ord)],'color','w');
        caxis([-1.5 1.5]);
        xlim([-2. 1.5]);
        set(gca,'ydir','normal');
        title('Ctx LF-amplitude')
        subplot(2,2,2)
        imagesc(lags/Fsd,1:length(ord),lf8_utrig_ctx_hf_mat(ord,:));
%         imagesc(lags/Fsd,1:length(ord),lf8_utrig_lf8_mat(ord,:));
        hold on
        ...
        set(gca,'ydir','normal');
         title('Ctx HF-power')
       subplot(2,2,3)
        imagesc(lags/Fsd,1:length(ord),lf8_utrig_mp_mat(ord,:));
        hold on
        plot(corresp_mp_uplag(used_uptrans(ord)),1:length(ord),'w','linewidth',1.)
        line([0 0],[1 length(ord)],'color','w');
        caxis([-1.5 1.5]);
        xlim([-2. 1.5]);
        set(gca,'ydir','normal');
        title('MEC MP')
        subplot(2,2,4)
        imagesc(lags/Fsd,1:length(ord),lf8_utrig_hpc_hf_mat(ord,:));
        hold on
        plot(corresp_mp_uplag(used_uptrans(ord)),1:length(ord),'w','linewidth',1.)
        line([0 0],[1 length(ord)],'color','w');
        caxis([-1.5 1.5]);
        ...
        pname = ['C:\persDowns_paper\Figs\sort_utrigs\' sprintf('Cell%d',d)];
...
save new_down_trig_avgs5 lags *trig* *skip dc_* avg_* std_* used_ctx*
...
figure; 
subplot(2,1,1);hold on
h1=shadedErrorBar(lags/Fsd,nanmean(lf8_utrig_ctx_mua(pup_used,:)),nanstd(lf8_utrig_ctx_mua(pup_used,:))/sqrt(sum(~isnan(lf8_utrig_ctx_mua(pup_used,1)))),{'color','k'});
h2=shadedErrorBar(lags/Fsd,nanmean(mp_utrig_ctx_mua(pup_used,:)),nanstd(mp_utrig_ctx_mua(pup_used,:))/sqrt(sum(~isnan(mp_utrig_ctx_mua(pup_used,1)))),{'color','r'});
xlim([-2 3]);
xlabel('Time (s)','fontsize',12);
ylabel('HPC MUA rate (z)','fontsize',12);
title('Up-transition triggered','fontsize',12);
...
line([-2 3],[0 0],'color','k');
subplot(2,1,2);hold on
h1=shadedErrorBar(lags/Fsd,nanmean(lf8_dtrig_ctx_mua(pup_used,:)),nanstd(lf8_dtrig_ctx_mua(pup_used,:))/sqrt(sum(~isnan(lf8_dtrig_ctx_mua(pup_used,1)))),{'color','k'});
h2=shadedErrorBar(lags/Fsd,nanmean(mp_dtrig_ctx_mua(pup_used,:)),nanstd(mp_dtrig_ctx_mua(pup_used,:))/sqrt(sum(~isnan(mp_dtrig_ctx_mua(pup_used,1)))),{'color','r'});
xlim([-2 3])
xlabel('Time (s)','fontsize',12);
ylabel('HPC MUA rate (z)','fontsize',12);
title('Down-transition triggered','fontsize',12);
...
hold on;
h1 = shadedErrorBar(lags/Fsd,nanmean(lf8_dtrig_lf8_pup(pup_used,:)),nanstd(lf8_dtrig_lf8_pup(pup_used,:))/sqrt(length(pup_used)),{'color','b'});
h2 = shadedErrorBar(lags/Fsd,nanmean(lf8_dtrig_lf8_npup(pup_used,:)),nanstd(lf8_dtrig_lf8_npup(pup_used,:))/sqrt(length(pup_used)),{'color','r'});
h3 = shadedErrorBar(lags/Fsd,nanmean(lf8_dtrig_mp_pup(pup_used,:)),nanstd(lf8_dtrig_mp_pup(pup_used,:))/sqrt(length(pup_used)),{'color','k'});
h4 = shadedErrorBar(lags/Fsd,nanmean(lf8_dtrig_mp_npup(pup_used,:)),nanstd(lf8_dtrig_mp_npup(pup_used,:))/sqrt(length(pup_used)),{'color','g'});
...
% print('pers_ups_dtrig_avgs_LFPMP','-dpdf');
% close
...
fillPage(gcf,'papersize',[6 5]);
% print('pers_ups_dtrig_avgs_mua','-dpdf');
% close

% subplot(3,1,3);hold on
figure; hold on
h1=shadedErrorBar(lags/Fsd,nanmean(lf8_dtrig_lf8hf_pup(pup_used,:)),nanstd(lf8_dtrig_lf8hf_pup(pup_used,:))/sqrt(length(pup_used)),{'color','b'});
...
ylabel('Amplitude (z)','fontsize',14);
fillPage(gcf,'papersize',[6 5]);
% print('pers_ups_dtrig_avgs_pow','-dpdf');
% close
...
%% DURATION-CONTROLLED PERS UPS
n_pup_trial = sum(~isnan(lf8_dtrig_lf8_pup_trial(pup_used,:)));
n_npup_trial = sum(~isnan(lf8_dtrig_lf8_npup_trial(pup_used,:)));
xr = [-1.75 1.75];

figure;
subplot(3,1,1);
hold on
h1 = shadedErrorBar(lags/Fsd,nanmean(lf8_dtrig_lf8_pup_trial(pup_used,:)),nanstd(lf8_dtrig_lf8_pup_trial(pup_used,:))./sqrt(sum(~isnan(lf8_dtrig_lf8_pup_trial(pup_used,:)))),{'color','b'});
h2 = shadedErrorBar(lags/Fsd,nanmean(lf8_dtrig_lf8_npup_trial(pup_used,:)),nanstd(lf8_dtrig_lf8_npup_trial(pup_used,:))./sqrt(sum(~isnan(lf8_dtrig_lf8_npup_trial(pup_used,:)))),{'color','r'});
legend([h1.mainLine h2.mainLine],{'Pers','Non-pers'});
xlim(xr)
yl = ylim(); 
line([0 0],yl,'color','k','linestyle','--');
line([-2 3],[0 0],'color','k','linestyle','--');
xlabel('Time lag (s)','fontsize',14);
ylabel('Amplitude (z)','fontsize',14);
title('LF-amplitude','fontsize',14);

subplot(3,1,2);hold on
h1 = shadedErrorBar(lags/Fsd,nanmean(lf8_dtrig_ctx_hf_pup_trial(pup_used,:)),nanstd(lf8_dtrig_ctx_hf_pup_trial(pup_used,:))./sqrt(sum(~isnan(lf8_dtrig_ctx_hf_pup_trial(pup_used,:)))),{'color','b'});
h2 = shadedErrorBar(lags/Fsd,nanmean(lf8_dtrig_ctx_hf_npup_trial(pup_used,:)),nanstd(lf8_dtrig_ctx_hf_npup_trial(pup_used,:))./sqrt(sum(~isnan(lf8_dtrig_ctx_hf_npup_trial(pup_used,:)))),{'color','r'});
legend([h1.mainLine h2.mainLine],{'Pers','Non-pers'});
xlim(xr)
yl = ylim(); 
line([0 0],yl,'color','k','linestyle','--');
...
xlabel('Time lag (s)','fontsize',14);
ylabel('Amplitude (z)','fontsize',14);
title('HF-power','fontsize',14);

subplot(3,1,3);hold on
h1 = shadedErrorBar(lags/Fsd,nanmean(lf8_dtrig_ctx_mua_pup_trial(pup_used,:)),nanstd(lf8_dtrig_ctx_mua_pup_trial(pup_used,:))./sqrt(sum(~isnan(lf8_dtrig_ctx_mua_pup_trial(pup_used,:)))),{'color','b'});
h2 = shadedErrorBar(lags/Fsd,nanmean(lf8_dtrig_ctx_mua_npup_trial(pup_used,:)),nanstd(lf8_dtrig_ctx_mua_npup_trial(pup_used,:))./sqrt(sum(~isnan(lf8_dtrig_ctx_mua_npup_trial(pup_used,:)))),{'color','r'});
legend([h1.mainLine h2.mainLine],{'Pers','Non-pers'});
xlim(xr)
yl = ylim(); 
line([0 0],yl,'color','k','linestyle','--');
...
xlabel('Time lag (s)','fontsize',14);
ylabel('Amplitude (z)','fontsize',14);
title('MUA','fontsize',14);
fillPage(gcf,'papersize',[5 13]);
fname = 'pers_ups_ctx_durcont';
% print(fname,'-dpdf');
%% PERS DOWNS
figure; hold on
% subplot(3,1,1);hold on
h1=shadedErrorBar(lags/Fsd,nanmean(lf8_utrig_lf8_pdown(pdown_used,:)),nanstd(lf8_utrig_lf8_pdown(pdown_used,:))/sqrt(length(pdown_used)),{'color','b'});
h2=shadedErrorBar(lags/Fsd,nanmean(lf8_utrig_lf8_npdown(pdown_used,:)),nanstd(lf8_utrig_lf8_npdown(pdown_used,:))/sqrt(length(pdown_used)),{'color','r'});
h3=shadedErrorBar(lags/Fsd,nanmean(lf8_utrig_mp_pdown(pdown_used,:)),nanstd(lf8_utrig_mp_pdown(pdown_used,:))/sqrt(length(pdown_used)),{'color','k'});
h4=shadedErrorBar(lags/Fsd,nanmean(lf8_utrig_mp_npdown(pdown_used,:)),nanstd(lf8_utrig_mp_npdown(pdown_used,:))/sqrt(length(pdown_used)),{'color','g'});
legend([h1.mainLine h2.mainLine h3.mainLine h4.mainLine],{'Ctx LFP Pers','Ctx LFP non-pers','MP pers','MP non-pers'});
xlim([-2 3])
yl = ylim(); 
line([0 0],yl,'color','k','linestyle','--');
...
title('Ctx LFP and MEC MP','fontsize',14);
fillPage(gcf,'papersize',[6 5]);
% print('pers_downs_utrig_avgs_LFPMP','-dpdf');
% close
...
title('Ctx MUA and Hpc MUA','fontsize',14);
fillPage(gcf,'papersize',[6 5]);
% print('pers_downs_utrig_avgs_mua','-dpdf');
% close
...
title('Ctx HFpow and Hpc HFpow','fontsize',14);
fillPage(gcf,'papersize',[6 5]);
% print('pers_downs_utrig_avgs_pow','-dpdf');
% close
...
%% DURATION-CONTROLLED PERS DOWNS
n_pdown_trial = sum(~isnan(lf8_utrig_lf8_pdown_trial(pdown_used,:)));
n_npdown_trial = sum(~isnan(lf8_utrig_lf8_npdown_trial(pdown_used,:)));
xr = [-1.75 1.75];

figure;
subplot(3,1,1);
hold on
h1 = shadedErrorBar(lags/Fsd,nanmean(lf8_utrig_lf8_pdown_trial(pdown_used,:)),nanstd(lf8_utrig_lf8_pdown_trial(pdown_used,:))./sqrt(sum(~isnan(lf8_utrig_lf8_pdown_trial(pdown_used,:)))),{'color','b'});
h2 = shadedErrorBar(lags/Fsd,nanmean(lf8_utrig_lf8_npdown_trial(pdown_used,:)),nanstd(lf8_utrig_lf8_npdown_trial(pdown_used,:))./sqrt(sum(~isnan(lf8_utrig_lf8_npdown_trial(pdown_used,:)))),{'color','r'});
legend([h1.mainLine h2.mainLine],{'Pers','Non-pers'});
xlim(xr)
yl = ylim(); 
line([0 0],yl,'color','k','linestyle','--');
...
subplot(3,1,2);
hold on
h1 = shadedErrorBar(lags/Fsd,nanmean(lf8_utrig_ctx_hf_pdown_trial(pdown_used,:)),nanstd(lf8_utrig_ctx_hf_pdown_trial(pdown_used,:))./sqrt(sum(~isnan(lf8_utrig_ctx_hf_pdown_trial(pdown_used,:)))),{'color','b'});
h2 = shadedErrorBar(lags/Fsd,nanmean(lf8_utrig_ctx_hf_npdown_trial(pdown_used,:)),nanstd(lf8_utrig_ctx_hf_npdown_trial(pdown_used,:))./sqrt(sum(~isnan(lf8_utrig_ctx_hf_npdown_trial(pdown_used,:)))),{'color','r'});
legend([h1.mainLine h2.mainLine],{'Pers','Non-pers'});
xlim(xr)
yl = ylim(); 
line([0 0],yl,'color','k','linestyle','--');
...
subplot(3,1,3);
hold on
h1 = shadedErrorBar(lags/Fsd,nanmean(lf8_utrig_ctx_mua_pdown_trial(pdown_used,:)),nanstd(lf8_utrig_ctx_mua_pdown_trial(pdown_used,:))./sqrt(sum(~isnan(lf8_utrig_ctx_mua_pdown_trial(pdown_used,:)))),{'color','b'});
h2 = shadedErrorBar(lags/Fsd,nanmean(lf8_utrig_ctx_mua_npdown_trial(pdown_used,:)),nanstd(lf8_utrig_ctx_mua_npdown_trial(pdown_used,:))./sqrt(sum(~isnan(lf8_utrig_ctx_mua_npdown_trial(pdown_used,:)))),{'color','r'});
legend([h1.mainLine h2.mainLine],{'Pers','Non-pers'});
xlim(xr)
yl = ylim(); 
line([0 0],yl,'color','k','linestyle','--');
...
%%
lf8_dtrig_DCmp_npup_trial_norm = bsxfun(@minus,lf8_dtrig_DCmp_npup_trial,dc_upstate_amp');
lf8_dtrig_DCmp_pup_trial_norm = bsxfun(@minus,lf8_dtrig_DCmp_pup_trial,dc_upstate_amp');
% lf8_dtrig_DCmp_pup_trial_norm = lf8_dtrig_DCmp_pup_trial;
figure; hold on
...
%%
lf8_utrig_DCmp_npdown_trial_norm = bsxfun(@minus,lf8_utrig_DCmp_npdown_trial,dc_downstate_amp');
...
h1=shadedErrorBar(lags/Fsd,nanmean(lf8_utrig_DCmp_npdown_trial_norm(pdown_used,:)),nanstd(lf8_utrig_DCmp_npdown_trial_norm(pdown_used,:))/sqrt(length(pdown_used)),{'color','r'});
