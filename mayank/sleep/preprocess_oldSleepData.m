...
%MEC
data(1).dir = '/Users/james/Analysis/Mayank/sleep/2012-7-5_Patch/2012-7-5_17-11-29';
data(1).ipsiLFPs = [2:8];
data(1).contraLFPs = [];
...
%MEC
data(2).dir = '/Users/james/Analysis/Mayank/sleep/2012-7-8_2/2012-7-8_13-9-45';
data(2).ipsiLFPs = [2:8];
data(2).contraLFPs = [];
...
%MEC
data(3).dir = '/Users/james/Analysis/Mayank/sleep/2012-7-10_Sleep_WC/2012-7-10_13-49-40';
data(3).ipsiLFPs = [2:8];
data(3).contraLFPs = [];
...
%MEC
data(4).dir = '/Users/james/Analysis/Mayank/sleep/2012-7-13#1/2012-7-13_13-31-49';
data(4).ipsiLFPs = [2:8];
data(4).contraLFPs = [];
...
%MEC
data(5).dir = '/Users/james/Analysis/Mayank/sleep/2012-7-13#2/2012-7-13_16-54-15';
data(5).ipsiLFPs = [2:8];
data(5).contraLFPs = [];
