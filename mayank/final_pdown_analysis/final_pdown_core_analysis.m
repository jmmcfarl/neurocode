...
for d = 1:length(data)
    ...
    nr_skipped_lfp_downs = skipped_lfp_downs;
    nr_non_skipped_lfp_downs = non_skipped_lfp_downs;
    ...
    core_data(d).nr_skipped_lfp_downs = nr_skipped_lfp_downs;
    core_data(d).nr_non_skipped_lfp_downs = nr_non_skipped_lfp_downs;
    ...
    non_skipped_lfp_ups = setdiff(1:length(up_trans_inds8),skipped_lfp_ups);
     ...
     nr_skipped_lfp_ups = skipped_lfp_ups;
    nr_non_skipped_lfp_ups = non_skipped_lfp_ups;
    ...
    core_data(d).nr_skipped_lfp_ups = nr_skipped_lfp_ups;
    core_data(d).nr_non_skipped_lfp_ups = nr_non_skipped_lfp_ups;
