function [LL, nullLL, pred_rate, G, gint, fgint, penLL] = NMMeval_model( nim, Robs, Xstims, Gmults, Rindx, regmat_custom)
%
% Usage: [LL, nullLL, pred_rate, G, gint, fgint, penLL] = NMMeval_model( nim, Robs, Xstims, <Gmults>, Rindx, <regmat_custom> )
%
