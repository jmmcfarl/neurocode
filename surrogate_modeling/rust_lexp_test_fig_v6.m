...
%%
fo = glm_quad;
fo = adjust_all_reg(fo,'lambda_dX',5);
fo = adjust_all_reg(fo,'lambda_dT',5);
fo = adjust_all_reg(fo,'lambda_d2XT',5);
fo = adjust_all_reg(fo,'lambda_L1x',15);
...
fo = adjust_all_reg(fo,'lambda_L1x',15);
fo = adjust_all_reg(fo,'lambda_d2XT',1);
fo = fitGLM_lexp(fo,stim_emb,spikebins,'tots',[],1e-4,1e-6);
