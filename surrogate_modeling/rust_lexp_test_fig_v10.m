...
desired_spacing = LAMBDA/5.5; %6.5
...
% gnmr3 = fitGNM_filters(gnmr2,stim_emb,spikebins,'none',[],1e-4,1e-6);
% gnmr3 = fitGNM_internal_NLs(gnmr3,stim_emb,spikebins,0,0);
% gnmr3_xvLL = getLL_GNM(gnmr3,xvstim_emb,xvspikebins,'none')
end
...
% save lexp_mod_gnm_fig_2 gnmr* quad* stc* sta*
