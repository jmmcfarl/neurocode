...
fo = glm_lexp;
fo = adjust_all_reg(fo,'lambda_dX',50);
fo = adjust_all_reg(fo,'lambda_dT',50);
fo = adjust_all_reg(fo,'lambda_L1x',200);
...
[glm_lexpfN,norm_vals_k] = normalizeRFs_lexp(glm_lexpf,stim_emb,1,0);
